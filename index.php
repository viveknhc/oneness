...
<body>
  ...
  <section class="text-olny-section">
    <div>
      <h2 class="text-reveal">At <span>Oneness Media Mill</span> , our aim will be to cater to all your
        <span>media</span> needs from
        <span>inception to execution</span>
      </h2>
    </div>
  </section>
  ...
  <section class="video-reveal">
    <div class="video-box">
      <video autoplay loop muted class="grow" src="assets/video/oneness-intro.mp4" width="100%">
      </video>
    </div>
  </section>
    ...
    <div class="container">
      ...
      <div class="owl-carousel testimonial-carousel">
        <div class="testimonial-card-box">
          <div class="card h-100">
            <p class="content">"Lorem, ipsum dolor sit amet consectetur adipisicing elit. Iure, a provident? Ipsa fuga
              vitae rerum
              doloremque nemo quasi"</p>
            <div class="text-end">
              <h5>Sharon Armin</h5>
              <p class="designation">Film Actor</p>
            </div>
            <img class="blur-shape" src="assets/images/blurshape.png" alt="">
          </div>
        </div>
